...
While it would have been possible to design a 3D printed case use, I  decided to go with one of the many weatherproof cases that are available. [Polycase](https://www.polycase.com) has a lot of choices. Since I was going to be opening it frequently to update software and collect recordings, I selected [one](https://www.polycase.com/wh-02) that uses latches to keep it closed instead of screws.
